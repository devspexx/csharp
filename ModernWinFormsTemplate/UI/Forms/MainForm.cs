...
namespace BorderlessForm
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // logo pictureBox1.MouseDown += TitleLabel_MouseDown;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            shadow = new Dropshadow(this)
            {
                ShadowBlur = 11,
                ShadowSpread = -5,
                ShadowColor = Color.FromArgb(35, 35, 38)
            };
        }
        ...
        {
            panel1.BackColor = Color.FromArgb(35, 35, 38);
            if (!formclosing)
            {
        ...
        {
            panel1.BackColor = Color.FromArgb(40, 40, 44);
            if (!formclosing)
            {
        ...
        {
            // event is called to many times and it prevents ui from normal rendering
        }

        private void MainForm_ResizeEnd(object sender, EventArgs e)
        {
            if (Size.Width >= Screen.PrimaryScreen.Bounds.Width ||
                Size.Height >= Screen.PrimaryScreen.Bounds.Height)
            {
                return;
            }
            shadow.Show();
